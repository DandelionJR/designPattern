...
public class FileUtil {
    ...
    public static void writeCommands(ArrayList commands) {
        try {
            FileOutputStream file = new FileOutputStream("src/commandPattern/client2/config.log");
            //创建对象输出流用于将对象写入到文件中
    ...
    public static ArrayList readCommands() {
        try {
            FileInputStream file = new FileInputStream("src/commandPattern/client2/config.log");
            //创建对象输入流用于从文件中读取对象
